...
urlpatterns = [
    ...
    path('reservation/<int:reservation_id>',
         editer_reservation, name="editer_Reservation"),
    ...
    path('modifier_message/<int:message_id>',
         modifier_message, name='modifier_message'),
    path('suprimer_message/<int:message_id>',
         suprimer_message, name='suprimer_message'),
    path('suprimer_reservation/<int:reservationId>',
         suprimer_reservation, name='suprimer_reservation'),
