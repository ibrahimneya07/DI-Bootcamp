...
class AdminAvis(admin.ModelAdmin):
    list_dipslay = ['id', 'author', 'last_updated',
                    'created_on', 'published', 'content']
...
class AdminChambre(admin.ModelAdmin):
    lisst_display = ['id', 'date_disponible', 'date_reservation', 'prix',
                     'dure_sejour', 'nombre_personne', 'date_ariver', 'date_depart']
...
class AdminReservation(admin.ModelAdmin):
    list_display = ['id', 'date_reservation',
                    'dure_sejour', 'author', 'reservation']
