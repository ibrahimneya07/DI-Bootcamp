...
from .models import Pays, Categorie, Film, Directeur, Poste, Commentaire
...
class AdminFilm(admin.ModelAdmin):
    list_display = ['id', 'titre', 'date_sortie',
                    'film_nationalite', 'categorie']
...
class AdminCommentaire(admin.ModelAdmin):
    list_display = ['id', 'author', 'last_updated',
