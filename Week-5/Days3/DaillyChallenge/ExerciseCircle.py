...
class Circle:
    ...
    #method
    def aire(self):
        return "Airedu cercle est {}".format(3.14*self.rayon*self.rayon)    
    #method
    def __eq__(self,other):
        ...
        if self.rayon*2*3.14==other.rayon*2*3.14:
            ...
            print(self.liste)
            return "Les deux cercles sont les memes"
        elif self.rayon*2*3.14 >other.rayon*2*3.14:
            
            return "Le cercle 1 est le plus grand"

        else:
            return "Le cercle 2 est le plus grand"
    #methos
